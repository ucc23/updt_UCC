...
def plot(name, clust1):
    ...
    plt.subplot(232)
    plt.scatter(clust1["pmRA"], clust1["pmDE"], alpha=0.5, c=clust1["Prob"])
    plt.xlabel("pmRA")
    plt.ylabel("pmDE")
    plt.colorbar()
    ...
    plt.subplot(234)
    plt.scatter(clust1["BP-RP"], clust1["Gmag"], alpha=0.5, c=clust1["Prob"])
