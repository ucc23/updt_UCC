...
These files correspond to the 250814 version of the UCC database (https://ucc.ar),
...
([Perren et al. 2023](https://ui.adsabs.harvard.edu/abs/2023MNRAS.526.4107P)) using the following BibTex snippet:
