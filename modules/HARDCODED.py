...
# This file contains the preferred order in which the OCs where named in the first
# version of the UCC. This name is important because the OCs files will be named
# using it.
naming_order = (
    "blanco",
    "westerlund",
